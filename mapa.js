            ...
            $(document).ready(function(){
                    ...
                    drone_mini = L.imageOverlay('img/drone2.png',[[-21.70983548137554, -46.8275536418],[-21.711427499655034, -46.8260716641]],{opacity:1});

                    satelite = L.imageOverlay('img/google_.jpeg',[[-21.7124493233723967,-46.8290725459892343],[-21.7091060887318399,-46.8242553249941338]]);
...
//                    ctlEasyButton.button.style.backgroundColor = 'orange';
                    ...
                    /// ***** Mini Map ******    
                    minimap = new L.Control.MiniMap(drone_mini, {toggleDisplay: true, minimized:true, position:'bottomright', maxZoom:20, minZoom:19, 
                    ...
                    mymap.on('zoomend', function(){
                        ...
                        switch (zoomlevel){
                            case 23:
                                tumulos.setStyle({weight: 3, fillOpacity:0.1});
                                //teste();
                                //alert('Zoom Igual a '+zoomlevel);
                                break;
                            default:
                                tumulos.setStyle({weight: 1.5, fillOpacity:0.5});
                                //alert('Zoom Igual a '+zoomlevel);
                                break;
                    ...
                    /// ***** Definição dos Estilos para os tumulos *****
                     ...
                     var sidebar = L.control.sidebar({ container: 'sidebar', closeButton: 'true', position: 'left' }).addTo(mymap);
